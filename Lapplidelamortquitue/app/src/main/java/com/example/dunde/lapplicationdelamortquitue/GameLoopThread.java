...
public class GameLoopThread extends Thread
{
    ...
    public void run()
    {
        ...
        // cf : surfaceDestroyed() dans com.example.dunde.lapplicationdelamortquitue.GameView.java
        while (running)
        {
            // horodatage actuel
            startTime = System.currentTimeMillis();

            // mise à jour du déplacement des ojets dans com.example.dunde.lapplicationdelamortquitue.GameView.update()
...
} // class com.example.dunde.lapplicationdelamortquitue.GameLoopThread