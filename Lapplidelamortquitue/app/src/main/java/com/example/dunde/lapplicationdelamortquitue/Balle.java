 ...
 * Created by dunde on 29/12/2016.
 */
...
class Balle
{
    ...
    // Constructeur de l'objet "com.example.dunde.lapplicationdelamortquitue.Balle"
    ...
    // on attribue à l'objet "com.example.dunde.lapplicationdelamortquitue.Balle" l'image passée en paramètre
    ...
    public void resize(int wScreen, int hScreen) {
        ...
        balleW=wScreen/5;
        balleH=wScreen/5;
        img = setImage(mContext,R.mipmap.vador,balleW,balleH);
    }
...
} // public class com.example.dunde.lapplicationdelamortquitue.Balle
